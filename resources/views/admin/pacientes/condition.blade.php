                        ...
                        <tbody>
                            ...
                            @foreach ($pacientes as $paciente)
                                <tr>
                                    ...
                                    <td style="text-align:center">{{ $paciente->categoria->codigo }}</td> 
                                    <td style="text-align:center">{{ $paciente->estado->nombre }}</td>                                 
                                    <td style="text-align:center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{url('admin/pacientes/'.$paciente->id)}}" type="button" class="btn btn-info btn-sm action-btn" data-bs-toggle="tooltip" title="Editar estado"><i class="bi bi-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
